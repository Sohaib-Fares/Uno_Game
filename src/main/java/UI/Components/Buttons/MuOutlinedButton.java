 ...
 * This button style is designed for secondary actions with a more rounded appearance.
 * Inherits core functionality from MuButton while enforcing a consistent corner radius.
 */
public class MuOutlinedButton extends MuButton {
    ...
    public MuOutlinedButton(String text, Color bgColor, Color textColor, int width, int height) {
        super(text, bgColor, textColor, width, height, OUTLINED_RADIUS);
    }
   
    public MuOutlinedButton(String text, Color bgColor, Color textColor, int width, int height, 
                           int outlineThickness, Color outlineColor) {
        super(text, bgColor, textColor, width, height, OUTLINED_RADIUS, outlineThickness, outlineColor);
    }
}